...
function AdBanner() {
	...
	return (
		<div className="w-full bg-slate-900 py-4 px-4">
			<div className="max-w-md mx-auto">
				{/* Google AdSense Container */}
				<div className="bg-slate-700 rounded-lg p-4 border border-slate-600 min-h-[100px] flex items-center justify-center">
					{/* Google AdSense Ad */}
					<ins 
