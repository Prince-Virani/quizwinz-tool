        ...
        <Card className="bg-slate-800 border-slate-700">
          ...
          <CardContent className="space-y-6 text-slate-300">
            <section>
              ...
              <p>
                By accessing and using Newswithlk Quiz, you accept and agree to be bound by the terms and provision of this
                agreement.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Permission is granted to temporarily use Newswithlk Quiz for personal, non-commercial transitory viewing only.
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>Coins earned in Newswithlk Quiz have no real-world monetary value</li>
            ...
            <section>
              ...
              <p>
                Newswithlk Quiz shall not be liable for any indirect, incidental, special, consequential, or punitive damages
            ...
            <div className="bg-gradient-to-r from-orange-400/20 to-yellow-500/20 p-4 rounded-lg border border-orange-500/30">
              <p className="text-orange-300 font-medium">
                By continuing to use Newswithlk Quiz, you agree to these terms and conditions.
              </p>
            </div>
          </CardContent>
        </Card>
